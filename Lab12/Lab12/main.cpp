...
void mouseCallback(GLFWwindow* window, double xpos, double ypos) {
	...
	// Optionally, you can update the view matrix here if needed
...
void initObjects() {
	...
	//nanosuit.LoadModel("objects/leaf/leaf.obj");
...
void initShaders() {
	...
	//fog 
	myCustomShader.loadShader("shaders/shaderStartFog.vert", "shaders/shaderStartFog.frag");
	//fragment elimination
	//myCustomShader.loadShader("shaders/shaderStartFragElim.vert", "shaders/shaderStartFragElim.frag");
